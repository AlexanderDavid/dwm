...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_Escape, spawn,
     SHCMD("prompt \"Leave Xorg?\" \"killall Xorg\"")},
    ...
    {MODKEY, XK_m, spawn, SHCMD("st -e spotify-tui")},
    ...
    {MODKEY, XK_F1, spawn,
     SHCMD("groff -mom $HOME/.local/share/larbs/readme.mom -Tpdf | zathura -")},
    {MODKEY, XK_F2, quit, {0}},
    {MODKEY, XK_F3, spawn, SHCMD("displayselect")},
    {MODKEY, XK_F4, spawn,
     SHCMD("prompt \"Hibernate computer?\" \"sudo -A zzz -Z\"")},
    ...
    {0, XF86XK_AudioMute, spawn,
     SHCMD("amixer sset Master toggle ; amixer sset Speaker toggle")},
    ...
    {0, XF86XK_Battery, spawn,
     SHCMD("notify-send \"Battery status\" \"$(batstat)\"")},
